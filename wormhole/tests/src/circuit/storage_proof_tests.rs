...
fn tampered_proof_fails() {
	...
	let proof = StorageProof::new(&tampered_proof, default_root_hash(), LeafInputs::test_inputs());
...
fn fuzz_tampered_proof() {
	...
	for i in 0..FUZZ_ITERATIONS {
		...
		let proof =
			StorageProof::new(&tampered_proof, default_root_hash(), LeafInputs::test_inputs());
